...
import (
	...
	"github.com/jsotogaviard/discount/restapi/operations"
	"github.com/jsotogaviard/discount/restapi/operations/checkout"
	"github.com/jsotogaviard/discount/application"
)

//go:generate swagger generate server --target .. --name  --spec ../doc/discount.yaml

func configureFlags(api *operations.CheckoutAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CheckoutAPI) http.Handler {
